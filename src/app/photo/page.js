...
const Photo = () => {
    return (
        <div className='my-6'>
            <div className='w-[25%] md:w-[15%] mx-auto h-26 md:h-50 p-10 rounded-full border border-[#dab95c] bg-[#dab95c] cursor-pointer'>
                <label htmlFor="photo" className='sm:text-xl md:text-3xl cursor-pointer' >
                    Photo <br />  Upload
            ...
            <div className='w-[80%] mx-auto border border-white md:px-12 py-3 my-6'>
                <fieldset className='flex justify-around md:gap-6 mt-6'>
                        ...
                        <div className="flex items-center mb-4">
                            <input id="country-option-3" type="radio" name="countries" value="Spain" className="sm:w-2 md:w-4 sm:h-2 md:h-4border-[#dab95c] focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:bg-gray-700 dark:border-gray-600"/>
            ...
            <div className='w-[80%] mx-auto flex flex-col items-center my-6'>
                <h2 className='sm:text-sm md:text-3xl font-medium'>NATIONAL IDENTIFICATION NO</h2>
                ...
                <div className='flex justify-around items-center gap-6 md:gap-8'>
                    <div className='sm:w-150 md:w-180 sm:h-120 md:h-130 p-5 rounded-[20px] border border-[#dab95c] bg-[#dab95c] cursor-pointer'>
                        <label htmlFor="photo" className='sm:text-xl md:text-3xl cursor-pointer' >
