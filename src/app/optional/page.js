    ...
    return (
        <div>
            ...
            <div>
                ...
                <fieldset className='grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 items-center justify-items-start md:justify-items-center my-6 pl-12 md:pl-0'>
            ...
            <div className='my-6'>
                ...
                <hr className='w-[40%] mx-auto h-1 bg-[#dab95c] my-1 md:my-3' />
            ...
            <div className='flex flex-col items-center my-3'>
                <input type="text" name="firstName" className='outline-none w-[50%] md:w-[40%] p-2 m-2 border-2 border-[#dab95c] bg-[#df2926] rounded' placeholder='Whats app'/>
                <input type="text" name="MiddleName" className='outline-none w-[50%] md:w-[40%] p-2 m-2 border-2 border-[#dab95c] bg-[#df2926] rounded' placeholder='Facebook'/>
                <input type="text" name="LastName" className='outline-none w-[50%] md:w-[40%] p-2 m-2 border-2 border-[#dab95c] bg-[#df2926] rounded' placeholder='Discord'/>
                <input type="text" name="LastName" className='outline-none w-[50%] md:w-[40%] p-2 m-2 border-2 border-[#dab95c] bg-[#df2926] rounded' placeholder='Telegram'/>
            </div>
